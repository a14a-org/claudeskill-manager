 ...
 */
export const deriveKeyFromPassphrase = (passphrase: string, salt: Uint8Array): DerivedKey => {
...
export const encryptTeamKeyForMember = (
	...
	const { ephemeralPublicKey, ciphertext, iv, tag } = encryptForRecipient(teamKey, memberPublicKey);
